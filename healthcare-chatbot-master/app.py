...
def getSeverityDict():
    severityDictionary = {}  # Define severityDictionary globally
    with open('MasterData/symptom_severity.csv') as csv_file:
        ...
        try:
            ...
            print("Error: IndexError occurred while processing symptom severity data.")
...
def tree_to_code(tree, feature_names):
    ...
    def recurse(node, depth):
        if tree_.feature[node] != _tree.TREE_UNDEFINED:
            ...
            symptoms_given = present_disease  # Replace reduced_data with the appropriate DataFrame or column name
